...
# ======================================================
# CLASSIFICADOR — identifica se existe memória individual
# ======================================================
...
json
    ...
    result = run_llm(verification_prompt, model="gpt-4o-mini")
    ...
    # ======= REGRAS DURAS (segurança extra) =======
    # Se a frase cita um arquiteto ou profissional → NÃO grava.
...
# ======================================================
# SALVA MEMÓRIA (se for válida)
# ======================================================


def store_individual_memory(username: str, info: str):
    """
    Grava memória individual no banco, evitando duplicatas vetoriais.
    """
    if not info:
        return False
...
# ======================================================
# RECUPERA TODAS MEMÓRIAS DAQUELE USUÁRIO
# ======================================================


def load_individual_memory(username: str) -> str:
    """
    Retorna as memórias individuais do usuário, formatadas para prompt.
    """
